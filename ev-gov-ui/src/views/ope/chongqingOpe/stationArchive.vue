    ...
    <a-card>
      <template slot="title">
        <span style="margin-left: 12px">
          <div class="titleFlag"></div>充电站建设统计信息
        </span>
      </template>
      <template slot="extra">
        ...
        <a-dropdown>
          <a-menu slot="overlay" style="padding:8px 12px;">
            <a-checkbox-group
              ...
              :defaultValue="['stationname','address','areaCode','stationtype','stationstatus','stationtel','construction','stationlng','stationlat']"
            >
              <a-row>
...
export default {
  ...
  created () {
    ...
    this.$store
      ...
      .then(res => {
        ...
        that.columns.forEach((item, index, arr) => {
          if (arr[index].dataIndex == "stationtype") {
    ...
    this.$store
      ...
      .then(res => {
        ...
        that.columns.forEach((item, index, arr) => {
          if (arr[index].dataIndex == "stationstatus") {
    ...
    this.$store
      ...
      .then(res => {
        ...
        that.columns.forEach((item, index, arr) => {
          if (arr[index].dataIndex == "construction") {
  ...
  methods: {
    ...
    handleTableChange(pagination, filters, sorter) {
      ...
      this.$store.dispatch("OpeStationListByPage", data).then(res => {
    ...
    expTable(){
      ...
      this.$store.dispatch("OpeStationListExp", params).then(res => {
