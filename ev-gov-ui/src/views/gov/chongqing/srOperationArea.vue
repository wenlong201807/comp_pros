<template>
  <div>
    <a-card style="margin-bottom:24px">
      ...
      <a-row>
        <a-col id="charge" style="width: 100%;height:350px;"></a-col>
      </a-row>
    </a-card>
    <a-card style="margin-bottom:24px;">
      <template slot="title">
      ...
      <a-row>
        <div id="chargeTimes" style="width: 100%;height:350px;"></div>
      </a-row>
    </a-card>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    initData () {
      ...
      this.$store.dispatch('StakeDataByAreaTime', params).then(res => {
