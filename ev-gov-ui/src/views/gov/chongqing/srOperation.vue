    ...
    <a-card style="margin-bottom:24px">
      <template slot="title">
        <span style="margin-left: 12px">
          <div class="titleFlag"></div>运营商日充电量趋势
        </span>
      </template>
      <template slot="extra">
      ...
      <a-row>
        <a-col id="charge" style="width: 100%;height:450px;"></a-col>
      </a-row>
    </a-card>
    <a-card style="margin-bottom:24px;">
      <template slot="title">
        <span style="margin-left: 12px">
          <div class="titleFlag"></div>运营商日充电次数趋势
        </span>
      </template>
      <a-row>
        <a-col :md="8" :sm="24" class="statisticData">
      ...
      <a-row>
        <div id="chargeTimes" style="width: 100%;height:450px;"></div>
      </a-row>
    </a-card>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    initData () {
      ...
      this.$store.dispatch('ListStakeDataByOperatorTime', params).then(res => {
    ...
    initAreaData () {
      ...
      this.$store.dispatch('QueryAreaDataMax', params).then(res => {
