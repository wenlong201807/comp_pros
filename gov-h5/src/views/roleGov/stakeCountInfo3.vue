<template>
  <div class="con-liu">
      ...
      <scroller :on-refresh="refresh" ref="myscroller" style="width: 100%;height: 100%;">
        ...
        <van-row class="chart">
          <h4 class="common-title1">
            <span>实时充电功率变化</span>
            <div class="allScreen" @click="fullScreenBtn"></div>
          </h4>
          <div id="echart2">
          </div>
        </van-row>
    ...
    <FullLineChart v-if="fullScreen" @close="closeFullScreen"></FullLineChart>
  </div>
</template>
<script>
import ReconnectingWebSocket from 'reconnectingwebsocket'
import { getStore } from 'src/utils/store'
import FullLineChart from '../../components/FullChart/FullLineChart'
export default {
...
<style scoped>
  ...
  .allScreen{
    background: url("../../assets/operator/full.png");
