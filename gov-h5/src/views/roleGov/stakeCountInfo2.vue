  ...
  <div class="con-liu">
    ...
    <div class="count-info-con">
      <scroller :on-refresh="refresh" ref="myscroller" style="width: 100%;height: 100%;">
        <div class="top">
          <h4><img src="../../assets/roleGov/icon1.png" alt=""> <span>重庆市电动汽车桩统计</span></h4>
          <van-row style="text-align: center">
            <van-col span="12">
              <p class="value">
                <span class="valueText">总次数</span>
                <span >{{ totalTimes }}</span>万次
              </p>
            </van-col>
            <van-col span="12">
              <p class="value">
                <span class="valueText">总电量</span>
                <span >{{ ele }}</span>万千瓦时
              </p>
            </van-col>
          </van-row>
        ...
        <van-row class="chart">
          <h4 class="common-title1"> <span>单日充电量</span></h4>
          <div id="echart1">
          </div>
        </van-row>
        <van-row class="chart">
          <h4 class="common-title1"> <span>单日充电次数变化趋势</span></h4>
          <div id="echart2">
          </div>
        </van-row>
      </scroller>
