  ...
  <div>
    <div class="registerTop">
      <van-row class="evaluateTop">
        <van-col span="2" style="position:absolute;"> <span class="icon"
        ...
        <div class="carWrap">
          <div class="blockDiv">
            <div class="block"
              ...
              <div class="msgTitle textSize"><span class="pinPai">14123</span>(个)</div>
            </div>
            <div class="block"
            ...
            <div class="block"
              ...
              <div class="msgTitle textSize"><span class="pinPai">6770</span>(个)</div>
            </div>
            <div class="block"
              ...
              <div class="msgTitle textSize"><span class="pinPai">7351</span>(个)</div>
            </div>
            <div class="block"
                 style="border-bottom:0;">
              <div class="msgTitle">一体设备</div>
              <!-- <div class="msgTitle textSize"><span class="pinPai">{{ jioliuYiTi }}</span>(个)</div> -->
              <div class="msgTitle textSize"><span class="pinPai">0</span>(个)</div>
            </div>
