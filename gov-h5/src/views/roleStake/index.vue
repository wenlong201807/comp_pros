<template>
  <div class="con-liu">
    ...
    <div class="content">
      ...
      <!--        <van-row>-->
      <!--          <van-col span="6">-->
      <!--            <img src="../../assets/roleStake/roleStake01.png" alt="">-->
      <!--            <p>充电站</p>-->
      <!--          </van-col>-->
      <!--          <van-col span="6">-->
      <!--            <img src="../../assets/roleStake/roleStake02.png" alt="">-->
      <!--            <p>充电桩</p>-->
      <!--          </van-col>-->
      <!--          <van-col span="6">-->
      <!--            <img src="../../assets/roleStake/roleStake03.png" alt="">-->
      <!--            <p>充电枪</p>-->
      <!--          </van-col>-->
      <!--          <van-col span="6">-->
      <!--            <img src="../../assets/roleStake/roleStake04.png" alt="">-->
      <!--            <p>额定功率</p>-->
      <!--          </van-col>-->
      <!--        </van-row>-->
      <!--      </div>-->
          ...
          <van-col span="12">
            <div class="box">
              ...
              <div class="right-info">
                ...
                <p class="per">占比：{{ (100*stakeStatus.type1/stakeAll).toFixed(2)?0:(100*stakeStatus.type1/stakeAll).toFixed(2) }}%</p>
              </div>
            </div>
          </van-col>
          <van-col span="12">
            <div class="box">
              ...
              <div class="right-info">
                ...
                <p class="per">占比：{{ (100*stakeStatus.type2/stakeAll).toFixed(2)?0: (100*stakeStatus.type2/stakeAll).toFixed(2) }}%</p>
              </div>
            </div>
          </van-col>
          <van-col span="12">
            <div class="box">
              ...
              <div class="right-info">
                ...
                <p class="per">占比：{{ (100*stakeStatus.type3/stakeAll).toFixed(2)?0: (100*stakeStatus.type3/stakeAll).toFixed(2) }}%</p>
              </div>
            </div>
          </van-col>
          <van-col span="12">
            <div class="box">
              ...
              <div class="right-info">
                ...
                <p class="per">占比：{{ (100*stakeStatus.type4/stakeAll).toFixed(2)?0: (100*stakeStatus.type4/stakeAll).toFixed(2) }}%</p>
              </div>
            </div>
          </van-col>
          <van-col span="12">
            <div class="box">
              ...
              <div class="right-info">
                ...
                <p class="per">占比：{{ (100*stakeStatus.type5/stakeAll).toFixed(2)? 0:(100*stakeStatus.type5/stakeAll).toFixed(2) }}%</p>
              </div>
            </div>
          </van-col>
          <van-col span="12">
            <div class="box">
              ...
              <div class="right-info">
                ...
                <p class="per">占比：{{ (100*stakeStatus.type6/stakeAll).toFixed(2)?0:(100*stakeStatus.type6/stakeAll).toFixed(2) }}%</p>
              </div>
            </div>
          </van-col>
          <van-col span="12">
...
export default {
  ...
  data () {
    return {
      ...
      stakeBasicList: [
        ...
        { name: '建设规模', imgSrc: require('../../assets/roleStake/roleStake03.png') },
        { name: '接入电站', imgSrc: require('../../assets/roleStake/roleStake04.png') }
      ],
      stakeCountList: [
  ...
  methods: {
    ...
    goStakeCountInfo (index) {
      this.$router.push({
        path: '/roleStakeCountInfo' + (index + 1)
      })
    },
    goStakeBasicInfo (index) {
      this.$router.push({
        path: '/roleStakeBasicInfo' + (index + 1)
      })
    },
    init () {
    ...
    stakeStatisticsGet () {
      const params = [
        ...
        { 'field': 'operatorId', value: this.operatorId }
      ]
...
<style scoped>
  .con-liu .common-top{
    background: url("../../assets/roleStake/stakebg.png");
